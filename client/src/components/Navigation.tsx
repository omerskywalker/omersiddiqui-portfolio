      ...
      >
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <a href="https://resume-builder-pro-omerasiddiqui.replit.app/" target="_blank" rel="noopener noreferrer" data-testid="link-resume-nav">
              <Button
                size="sm"
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 bg-background/96 backdrop-blur-xl flex flex-col pt-20 px-6 pb-8">
          ...
          <div className="mt-6 pt-6 border-t border-border">
            <a href="https://resume-builder-pro-omerasiddiqui.replit.app/" target="_blank" rel="noopener noreferrer">
